...
// Mock devices
const mockDevices = [
  new MockMediaDeviceInfo({ deviceId: 'device1', kind: 'audioinput', label: 'Microphone 1', groupId: 'group1' }),
  new MockMediaDeviceInfo({ deviceId: 'device2', kind: 'audioinput', label: 'Microphone 2', groupId: 'group1' }),
  new MockMediaDeviceInfo({ deviceId: 'device3', kind: 'videoinput', label: 'Camera 1', groupId: 'group2' }),
];
...
describe('useSoundDevices', () => {
  ...
  it('should fetch and filter audio input devices', async () => {
    ...
    const expectedDevices = mockDevices.filter(device => device.kind === 'audioinput');
  ...
  it('should handle device changes', async () => {
    ...
    const updatedDevices = [
      new MockMediaDeviceInfo({ deviceId: 'device1', kind: 'audioinput', label: 'Microphone 1', groupId: 'group1' }),
      new MockMediaDeviceInfo({ deviceId: 'device4', kind: 'audioinput', label: 'New Microphone', groupId: 'group1' }),
    ];
