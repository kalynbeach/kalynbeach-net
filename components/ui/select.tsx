...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        "focus:bg-accent/60 focus:text-accent-foreground relative flex w-full cursor-default items-center rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50",
        className
      )}
      data-slot="item"
      {...props}
